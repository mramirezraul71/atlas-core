# ATLAS AutoFix Report — 20260304-102756
...
/status OK
{
    ...
    "nexus_active":  true,
    "nexus_last_check_ts":  1772637967.2319152,
    "nexus_last_error":  "",
...
== SMOKE: /llm ==
LLM OK -> route=FAST model=llama3.2:3b ms=3754
== SMOKE: Humanoid ==
/humanoid/status OK
...
POST /scheduler/job/create OK (job_id=7609da4f-e3b3-431a-8512-325632cdb4ba)
...
POST /agent/goal (plan_only) OK in 7219.4928ms (<15s)
...
GET /voice/status OK
POST /memory/thread/create OK (thread_id=1f59b945-f513-4add-a75b-76c81e8739a7)
...
POST /cursor/run OK but slow: 17969.8231ms
GET /cursor/status OK
POST /bench/run OK (level=quick)
POST /agent/improve (plan_only repo) OK in 87.7691ms (<15s)
...
POST /ga/run (scope=runtime mode=plan_only) OK in 3903.293ms (<15s)
GA report_path exists: C:\ATLAS_PUSH\snapshots\ga\GA_REPORT_20260304_152754.md
