# ATLAS AutoFix Report — 20260304-102940
...
== SMOKE: /llm ==
LLM OK -> route=FAST model=llama3.2:3b ms=7417
== SMOKE: Humanoid ==
/humanoid/status OK
...
POST /scheduler/job/create OK (job_id=9fbf199a-7d74-4465-839e-ce5071da30d6)
GET /scheduler/job/runs?job_id=... OK (runs: 1)
GET /watchdog/status OK
== SMOKE: Agent / Scaffold / Scripts / Deps / Web / Voice ==
POST /agent/goal OK but slow: 21110.977ms
...
GET /voice/status OK
POST /memory/thread/create OK (thread_id=e87017b4-4b9a-4034-921f-06776b825653)
...
POST /cursor/run OK but slow: 19732.8212ms
GET /cursor/status OK
POST /bench/run OK (level=quick)
POST /agent/improve (plan_only repo) OK in 82.0073ms (<15s)
...
POST /ga/run (scope=runtime mode=plan_only) OK in 1423.8789ms (<15s)
GA report_path exists: C:\ATLAS_PUSH\snapshots\ga\GA_REPORT_20260304_152940.md
GET /ga/status OK (mode=plan_only pending=20)
