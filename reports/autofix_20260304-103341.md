# ATLAS AutoFix Report — 20260304-103341
...
/status OK
{
    ...
    "nexus_active":  true,
    "nexus_last_check_ts":  1772638342.4018624,
    "nexus_last_error":  "",
...
== SMOKE: /llm ==
LLM OK -> route=FAST model=llama3.2:3b ms=3671
== SMOKE: Humanoid ==
/humanoid/status OK
...
POST /scheduler/job/create OK (job_id=7897f9c0-09f4-4bd6-80c0-6c0a68494faa)
GET /scheduler/job/runs?job_id=... OK (runs: 1)
GET /watchdog/status OK
== SMOKE: Agent / Scaffold / Scripts / Deps / Web / Voice ==
POST /agent/goal (plan_only) OK in 1535.4309ms (<15s)
...
GET /voice/status OK
POST /memory/thread/create OK (thread_id=6a401e6a-5a0a-4778-aa0f-7c1eb33d9217)
...
POST /cursor/run (plan_only) OK in 12817.608ms (<15s)
GET /cursor/status OK
POST /bench/run OK (level=quick)
POST /agent/improve (plan_only repo) OK in 84.202ms (<15s)
...
POST /ga/run (scope=runtime mode=plan_only) OK in 1413.9261ms (<15s)
GA report_path exists: C:\ATLAS_PUSH\snapshots\ga\GA_REPORT_20260304_153341.md
GET /ga/status OK (mode=plan_only pending=35)
