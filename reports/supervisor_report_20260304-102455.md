# ATLAS Supervisor Report — 20260304-102455

**Evento:** fs_event
**Workspace:** `C:\ATLAS_PUSH`
**Hora:** `2026-03-04T10:24:55`

## Archivos tocados (último evento)
- `C:\ATLAS_PUSH\_external\RAULI-VISION\cliente-local\simple-server.py`
- `C:\ATLAS_PUSH\_external\rauli-panaderia\project-manager.py`
- `C:\ATLAS_PUSH\_external\rauli-panaderia\rauli_updater.py`
- `C:\ATLAS_PUSH\_external\rauli-panaderia\scripts\configurar_automatizacion.py`
- `C:\ATLAS_PUSH\_external\rauli-panaderia\scripts\setup_una_vez.py`
- `C:\ATLAS_PUSH\_external\rauli-panaderia\scripts\vercel_config_deploy.py`
- `C:\ATLAS_PUSH\_external\rauli-panaderia\scripts\vercel_deploy_directo.py`
- `C:\ATLAS_PUSH\_external\rauli-panaderia\scripts\vercel_reinscribir.py`
- `C:\ATLAS_PUSH\_external\rauli-panaderia\scripts\verificar_render.py`
- `C:\ATLAS_PUSH\_external\rauli-panaderia\scripts\verificar_repo_y_vercel.py`
...
- `C:\ATLAS_PUSH\autonomous\evolution\backup_manager.py`
- `C:\ATLAS_PUSH\autonomous\evolution\evolution_orchestrator_v2.py`
- `C:\ATLAS_PUSH\autonomous\evolution\regression_tester.py`
- `C:\ATLAS_PUSH\autonomous\health_monitor\anomaly_detector.py`
- `C:\ATLAS_PUSH\autonomous\health_monitor\health_aggregator.py`
- `C:\ATLAS_PUSH\autonomous\health_monitor\service_health.py`
- `C:\ATLAS_PUSH\autonomous\learning\knowledge_graph.py`
- `C:\ATLAS_PUSH\autonomous\learning\route_optimizer.py`
- `C:\ATLAS_PUSH\autonomous\resilience\disaster_recovery.py`
- `C:\ATLAS_PUSH\autonomous\resilience\priority_queue.py`
- `C:\ATLAS_PUSH\autonomous\resilience\survival_mode.py`
- `C:\ATLAS_PUSH\autonomous\self_healing\circuit_breaker.py`
- `C:\ATLAS_PUSH\autonomous\self_healing\healing_orchestrator.py`
- `C:\ATLAS_PUSH\autonomous\self_healing\recovery_strategies.py`
- `C:\ATLAS_PUSH\autonomous\telemetry\alert_manager.py`
- `C:\ATLAS_PUSH\autonomous\telemetry\tracing_system.py`
- `C:\ATLAS_PUSH\brain\learning\knowledge_consolidator.py`
- `C:\ATLAS_PUSH\bridge\atlas_api_min.py`
- `C:\ATLAS_PUSH\chat_api_router.py`
- `C:\ATLAS_PUSH\chat_thread_manager.py`
- `C:\ATLAS_PUSH\docs\SUPERVISOR_AUTOTEST.md`
- `C:\ATLAS_PUSH\generar_audio.py`
- `C:\ATLAS_PUSH\inspect_db.py`
- `C:\ATLAS_PUSH\memory\autoprogrammer_daemon.py`
- `C:\ATLAS_PUSH\memory\conversation_api.py`
- `C:\ATLAS_PUSH\memory\conversation_thread_manager.py`
- `C:\ATLAS_PUSH\modules\atlas_architect\ans_logger.py`
- `C:\ATLAS_PUSH\modules\atlas_architect\atomic_patcher.py`
- `C:\ATLAS_PUSH\modules\atlas_architect\governance.py`
- `C:\ATLAS_PUSH\modules\atlas_architect\model_orchestrator.py`
- `C:\ATLAS_PUSH\modules\atlas_gui.py`
- `C:\ATLAS_PUSH\modules\atlas_telegram.py`
- `C:\ATLAS_PUSH\modules\atlas_telegram_bot.py`
- `C:\ATLAS_PUSH\modules\brain\dashboard_client.py`
- `C:\ATLAS_PUSH\modules\brain_registry.py`
- `C:\ATLAS_PUSH\modules\evolution\credentials.py`
- `C:\ATLAS_PUSH\modules\finanzas\primitives.py`
- `C:\ATLAS_PUSH\modules\global_vision\primitives.py`
- `C:\ATLAS_PUSH\modules\humanoid\agents\base.py`
- `C:\ATLAS_PUSH\modules\humanoid\agents\registry.py`
- `C:\ATLAS_PUSH\modules\humanoid\ai\auto_router.py`
- `C:\ATLAS_PUSH\modules\humanoid\ai\dynamic_router.py`
- `C:\ATLAS_PUSH\modules\humanoid\ai\external_llm.py`
- `C:\ATLAS_PUSH\modules\humanoid\ai\fallback.py`
- `C:\ATLAS_PUSH\modules\humanoid\ai\models.py`
- `C:\ATLAS_PUSH\modules\humanoid\ai\router.py`
- `C:\ATLAS_PUSH\modules\humanoid\ai\status.py`
- `C:\ATLAS_PUSH\modules\humanoid\ai\telemetry.py`
- `C:\ATLAS_PUSH\modules\humanoid\ans\api.py`
- `C:\ATLAS_PUSH\modules\humanoid\ans\brain_link.py`
- `C:\ATLAS_PUSH\modules\humanoid\ans\checks\base.py`
- `C:\ATLAS_PUSH\modules\humanoid\ans\engine.py`
- `C:\ATLAS_PUSH\modules\humanoid\ans\evidence.py`
- `C:\ATLAS_PUSH\modules\humanoid\ans\heals\restart_scheduler.py`
- `C:\ATLAS_PUSH\modules\humanoid\ans\incident.py`
- `C:\ATLAS_PUSH\modules\humanoid\ans\live_stream.py`
- `C:\ATLAS_PUSH\modules\humanoid\ans\mttr.py`
- `C:\ATLAS_PUSH\modules\humanoid\ans\reactor.py`
- `C:\ATLAS_PUSH\modules\humanoid\ans\registry.py`
