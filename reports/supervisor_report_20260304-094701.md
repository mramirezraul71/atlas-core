# ATLAS Supervisor Report — 20260304-094701

**Evento:** startup
**Workspace:** `C:\ATLAS_PUSH`
**Hora:** `2026-03-04T09:47:01`
...
/status OK
{
    ...
    "nexus_active":  true,
    "nexus_last_check_ts":  1772635610.7991288,
    "nexus_last_error":  "",
...
== SMOKE: /llm ==
LLM OK -> route=FAST model=llama3.2:3b ms=8926
== SMOKE: Humanoid ==
/humanoid/status OK
...
POST /scheduler/job/create OK (job_id=f53c7aea-e120-46b4-be20-448c221e4a65)
GET /scheduler/job/runs?job_id=... OK (runs: 1)
GET /watchdog/status OK
== SMOKE: Agent / Scaffold / Scripts / Deps / Web / Voice ==
POST /agent/goal (plan_only) OK in 14268.2587ms (<15s)
...
GET /voice/status OK
POST /memory/thread/create OK (thread_id=3494d97d-7ba1-473b-9e5d-b0e71c4c7dbc)
...
POST /cursor/run (plan_only) OK in 8498.6665ms (<15s)
GET /cursor/status OK
POST /bench/run OK (level=quick)
POST /agent/improve (plan_only repo) OK in 48.9275ms (<15s)
...
POST /ga/run (scope=runtime mode=plan_only) OK in 1133.5823ms (<15s)
GA report_path exists: C:\ATLAS_PUSH\snapshots\ga\GA_REPORT_20260304_144856.md
