# ATLAS Supervisor Report — 20260304-095740

**Evento:** startup
**Workspace:** `C:\ATLAS_PUSH`
**Hora:** `2026-03-04T09:57:40`
...
== SMOKE: /llm ==
LLM OK -> route=FAST model=llama3.2:3b ms=2506
== SMOKE: Humanoid ==
/humanoid/status OK
...
POST /scheduler/job/create OK (job_id=268d2362-eaaf-4e2d-96b3-51d9bd8bfb09)
GET /scheduler/job/runs FAIL: La operaciÃ³n sobrepasÃ³ el tiempo de espera.
GET /watchdog/status FAIL: La operaciÃ³n sobrepasÃ³ el tiempo de espera.
== SMOKE: Agent / Scaffold / Scripts / Deps / Web / Voice ==
POST /agent/goal (plan_only) OK in 10326.8493ms (<15s)
...
GET /voice/status OK
POST /memory/thread/create OK (thread_id=df27d2d9-5a5a-4a7f-bf88-dba57af651b0)
...
POST /cursor/run OK but slow: 18640.1404ms
GET /cursor/status OK
POST /bench/run OK (level=quick)
POST /agent/improve (plan_only repo) OK in 96.5129ms (<15s)
...
POST /ga/run (scope=runtime mode=plan_only) OK in 1138.7119ms (<15s)
GA report_path exists: C:\ATLAS_PUSH\snapshots\ga\GA_REPORT_20260304_145930.md
GET /ga/status OK (mode=plan_only pending=15)
