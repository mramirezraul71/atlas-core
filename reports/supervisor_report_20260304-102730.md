# ATLAS Supervisor Report — 20260304-102730

**Evento:** fs_event
**Workspace:** `C:\ATLAS_PUSH`
**Hora:** `2026-03-04T10:27:30`

## Archivos tocados (último evento)
- `C:\ATLAS_PUSH\.venv_nexus\Lib\site-packages\dateutil\rrule.py`
- `C:\ATLAS_PUSH\.venv_nexus\Lib\site-packages\fastapi\_compat.py`
- `C:\ATLAS_PUSH\.venv_nexus\Lib\site-packages\fastapi\applications.py`
- `C:\ATLAS_PUSH\.venv_nexus\Lib\site-packages\greenlet\__init__.py`
- `C:\ATLAS_PUSH\.venv_nexus\Lib\site-packages\greenlet\tests\__init__.py`
- `C:\ATLAS_PUSH\.venv_nexus\Lib\site-packages\greenlet\tests\fail_clearing_run_switches.py`
- `C:\ATLAS_PUSH\.venv_nexus\Lib\site-packages\greenlet\tests\fail_cpp_exception.py`
- `C:\ATLAS_PUSH\.venv_nexus\Lib\site-packages\greenlet\tests\fail_initialstub_already_started.py`
- `C:\ATLAS_PUSH\.venv_nexus\Lib\site-packages\greenlet\tests\fail_slp_switch.py`
- `C:\ATLAS_PUSH\.venv_nexus\Lib\site-packages\greenlet\tests\fail_switch_three_greenlets.py`
- `C:\ATLAS_PUSH\.venv_nexus\Lib\site-packages\greenlet\tests\fail_switch_three_greenlets2.py`
- `C:\ATLAS_PUSH\.venv_nexus\Lib\site-packages\greenlet\tests\fail_switch_two_greenlets.py`
- `C:\ATLAS_PUSH\.venv_nexus\Lib\site-packages\greenlet\tests\leakcheck.py`
- `C:\ATLAS_PUSH\.venv_nexus\Lib\site-packages\greenlet\tests\test_contextvars.py`
- `C:\ATLAS_PUSH\.venv_nexus\Lib\site-packages\greenlet\tests\test_cpp.py`
- `C:\ATLAS_PUSH\.venv_nexus\Lib\site-packages\greenlet\tests\test_extension_interface.py`
- `C:\ATLAS_PUSH\.venv_nexus\Lib\site-packages\greenlet\tests\test_gc.py`
- `C:\ATLAS_PUSH\.venv_nexus\Lib\site-packages\greenlet\tests\test_generator.py`
- `C:\ATLAS_PUSH\.venv_nexus\Lib\site-packages\greenlet\tests\test_generator_nested.py`
- `C:\ATLAS_PUSH\.venv_nexus\Lib\site-packages\greenlet\tests\test_greenlet.py`
- `C:\ATLAS_PUSH\.venv_nexus\Lib\site-packages\greenlet\tests\test_greenlet_trash.py`
- `C:\ATLAS_PUSH\.venv_nexus\Lib\site-packages\greenlet\tests\test_interpreter_shutdown.py`
- `C:\ATLAS_PUSH\.venv_nexus\Lib\site-packages\greenlet\tests\test_leaks.py`
- `C:\ATLAS_PUSH\.venv_nexus\Lib\site-packages\greenlet\tests\test_stack_saved.py`
- `C:\ATLAS_PUSH\.venv_nexus\Lib\site-packages\greenlet\tests\test_throw.py`
- `C:\ATLAS_PUSH\.venv_nexus\Lib\site-packages\greenlet\tests\test_tracing.py`
- `C:\ATLAS_PUSH\.venv_nexus\Lib\site-packages\greenlet\tests\test_version.py`
- `C:\ATLAS_PUSH\.venv_nexus\Lib\site-packages\greenlet\tests\test_weakref.py`
- `C:\ATLAS_PUSH\.venv_nexus\Lib\site-packages\httpcore\_models.py`
- `C:\ATLAS_PUSH\.venv_nexus\Lib\site-packages\httpcore\_sync\connection.py`
- `C:\ATLAS_PUSH\.venv_nexus\Lib\site-packages\httpcore\_sync\connection_pool.py`
- `C:\ATLAS_PUSH\.venv_nexus\Lib\site-packages\httpcore\_sync\http11.py`
- `C:\ATLAS_PUSH\.venv_nexus\Lib\site-packages\httpcore\_sync\http2.py`
- `C:\ATLAS_PUSH\.venv_nexus\Lib\site-packages\httpcore\_sync\http_proxy.py`
- `C:\ATLAS_PUSH\.venv_nexus\Lib\site-packages\httptools\__init__.py`
- `C:\ATLAS_PUSH\.venv_nexus\Lib\site-packages\httptools\_version.py`
- `C:\ATLAS_PUSH\.venv_nexus\Lib\site-packages\httptools\parser\errors.py`
- `C:\ATLAS_PUSH\.venv_nexus\Lib\site-packages\httptools\parser\protocol.py`
- `C:\ATLAS_PUSH\.venv_nexus\Lib\site-packages\idna\core.py`
- `C:\ATLAS_PUSH\.venv_nexus\Lib\site-packages\iniconfig\__init__.py`
- `C:\ATLAS_PUSH\.venv_nexus\Lib\site-packages\iniconfig\_version.py`
- `C:\ATLAS_PUSH\.venv_nexus\Lib\site-packages\jiter\__init__.py`
