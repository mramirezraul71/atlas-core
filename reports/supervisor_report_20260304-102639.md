# ATLAS Supervisor Report — 20260304-102639

**Evento:** fs_event
**Workspace:** `C:\ATLAS_PUSH`
**Hora:** `2026-03-04T10:26:39`

## Archivos tocados (último evento)
- `C:\ATLAS_PUSH\.venv_nexus\Lib\site-packages\_pytest\_py\error.py`
- `C:\ATLAS_PUSH\.venv_nexus\Lib\site-packages\_pytest\_py\path.py`
- `C:\ATLAS_PUSH\.venv_nexus\Lib\site-packages\_pytest\_version.py`
- `C:\ATLAS_PUSH\.venv_nexus\Lib\site-packages\_pytest\assertion\__init__.py`
- `C:\ATLAS_PUSH\.venv_nexus\Lib\site-packages\_pytest\assertion\rewrite.py`
- `C:\ATLAS_PUSH\.venv_nexus\Lib\site-packages\_pytest\capture.py`
- `C:\ATLAS_PUSH\.venv_nexus\Lib\site-packages\_pytest\config\__init__.py`
- `C:\ATLAS_PUSH\.venv_nexus\Lib\site-packages\_pytest\fixtures.py`
- `C:\ATLAS_PUSH\.venv_nexus\Lib\site-packages\_pytest\main.py`
- `C:\ATLAS_PUSH\.venv_nexus\Lib\site-packages\_pytest\mark\expression.py`
- `C:\ATLAS_PUSH\.venv_nexus\Lib\site-packages\_pytest\mark\structures.py`
- `C:\ATLAS_PUSH\.venv_nexus\Lib\site-packages\_pytest\monkeypatch.py`
- `C:\ATLAS_PUSH\.venv_nexus\Lib\site-packages\_pytest\nodes.py`
- `C:\ATLAS_PUSH\.venv_nexus\Lib\site-packages\_pytest\pytester.py`
- `C:\ATLAS_PUSH\.venv_nexus\Lib\site-packages\_pytest\python.py`
- `C:\ATLAS_PUSH\.venv_nexus\Lib\site-packages\_pytest\raises.py`
- `C:\ATLAS_PUSH\.venv_nexus\Lib\site-packages\_pytest\recwarn.py`
- `C:\ATLAS_PUSH\.venv_nexus\Lib\site-packages\_pytest\reports.py`
- `C:\ATLAS_PUSH\.venv_nexus\Lib\site-packages\_pytest\threadexception.py`
- `C:\ATLAS_PUSH\.venv_nexus\Lib\site-packages\_pytest\timing.py`
- `C:\ATLAS_PUSH\.venv_nexus\Lib\site-packages\_pytest\unittest.py`
- `C:\ATLAS_PUSH\.venv_nexus\Lib\site-packages\_pytest\unraisableexception.py`
- `C:\ATLAS_PUSH\.venv_nexus\Lib\site-packages\_yaml\__init__.py`
- `C:\ATLAS_PUSH\.venv_nexus\Lib\site-packages\aiohttp\client.py`
- `C:\ATLAS_PUSH\.venv_nexus\Lib\site-packages\aiohttp\cookiejar.py`
- `C:\ATLAS_PUSH\.venv_nexus\Lib\site-packages\aiohttp\formdata.py`
- `C:\ATLAS_PUSH\.venv_nexus\Lib\site-packages\aiohttp\http_exceptions.py`
- `C:\ATLAS_PUSH\.venv_nexus\Lib\site-packages\aiohttp\payload.py`
- `C:\ATLAS_PUSH\.venv_nexus\Lib\site-packages\aiohttp\pytest_plugin.py`
- `C:\ATLAS_PUSH\.venv_nexus\Lib\site-packages\aiohttp\web_exceptions.py`
