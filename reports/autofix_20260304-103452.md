# ATLAS AutoFix Report — 20260304-103452
...
/status OK
{
    ...
    "nexus_active":  true,
    "nexus_last_check_ts":  1772638417.4489377,
    "nexus_last_error":  "",
...
== SMOKE: /llm ==
LLM OK -> route=FAST model=llama3.2:3b ms=3530
== SMOKE: Humanoid ==
/humanoid/status OK
...
POST /scheduler/job/create OK (job_id=f20f9129-1181-49a9-b0ec-198369acc110)
GET /scheduler/job/runs?job_id=... OK (runs: 1)
GET /watchdog/status OK
== SMOKE: Agent / Scaffold / Scripts / Deps / Web / Voice ==
POST /agent/goal (plan_only) OK in 1436.2248ms (<15s)
...
GET /voice/status OK
POST /memory/thread/create OK (thread_id=c341acfa-1925-43c8-bb44-9c49c0aef206)
...
POST /cursor/run (plan_only) OK in 12982.5872ms (<15s)
GET /cursor/status OK
POST /bench/run OK (level=quick)
POST /agent/improve (plan_only repo) OK in 115.5055ms (<15s)
...
POST /ga/run (scope=runtime mode=plan_only) OK in 1444.0919ms (<15s)
GA report_path exists: C:\ATLAS_PUSH\snapshots\ga\GA_REPORT_20260304_153452.md
GET /ga/status OK (mode=plan_only pending=40)
