...
class DirectivesManager:
    ...
    def _create_default_metadata(self):
        ...
        default_metadata = {
            ...
            "global_enabled": True,
            "projects": {},
            "stats": {"total_projects": 0, "total_directives": 0, "last_backup": None},
        }
    ...
    def set_project_directives(self, project_name: str, content: str) -> bool:
        ...
        try:
            ...
            logger.error(
                f"Error estableciendo directivas del proyecto {project_name}: {e}"
            )
            return False
        ...
        try:
            ...
            for project in projects:
                ...
                summary["projects"][project] = {
                    ...
                    "preview": project_content[:200] + "..."
                    if len(project_content) > 200
                    else project_content,
                }
...
"""
    ...
    def _update_metadata(self):
        ...
        try:
            ...
            metadata["stats"]["total_directives"] = len(projects) + (
                1 if self.global_file.exists() else 0
            )
