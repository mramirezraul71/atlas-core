...
async def get_global_directives():
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail="Error obteniendo directivas globales"
        )
...
async def update_global_directives(request: DirectiveContent):
    ...
    try:
        ...
        if success:
            ...
            raise HTTPException(
                status_code=500, detail="Error actualizando directivas globales"
            )
    except Exception as e:
...
async def append_global_directives(request: DirectiveContent):
    ...
    try:
        ...
        if success:
            ...
            raise HTTPException(
                status_code=500, detail="Error agregando a directivas globales"
            )
    except Exception as e:
...
async def toggle_global_directives(request: ToggleRequest):
    ...
    try:
        ...
        if success:
            ...
            raise HTTPException(
                status_code=500, detail="Error cambiando estado de directivas globales"
            )
    except Exception as e:
...
async def get_project_directives(project_name: str):
    ...
    try:
        ...
        if not content:
            raise HTTPException(
                status_code=404, detail=f"Proyecto '{project_name}' no encontrado"
            )
        ...
        raise HTTPException(
            status_code=500, detail="Error obteniendo directivas del proyecto"
        )
...
async def create_or_update_project(request: ProjectDirective):
    ...
    try:
        success = directives_manager.set_project_directives(
            request.project_name, request.content
        )
        if success:
            return {
            ...
            raise HTTPException(
                status_code=500, detail="Error actualizando directivas del proyecto"
            )
    except Exception as e:
        logger.error(
            f"Error actualizando directivas del proyecto {request.project_name}: {e}"
        )
        raise HTTPException(
            status_code=500, detail="Error actualizando directivas del proyecto"
        )
...
async def create_project_from_template(
    project_name: str, request: ProjectTemplateRequest
):
    """Crear un proyecto desde template"""
    try:
        success = directives_manager.create_project_template(
        ...
        if success:
            ...
            raise HTTPException(
                status_code=500, detail="Error creando proyecto desde template"
            )
    except Exception as e:
...
async def toggle_project_directives(project_name: str, request: ToggleRequest):
    ...
    try:
        ...
        if success:
            ...
            raise HTTPException(
                status_code=500, detail="Error cambiando estado del proyecto"
            )
    except Exception as e:
...
async def get_active_directives(project_name: Optional[str] = Query(None)):
    ...
    try:
        ...
        return {
            ...
            if project_name
            else None,  # TODO: Implementar desde metadata
            "size": len(content),
            "directives_count": len(
                [
                    d
                    for d in [
                        directives_manager.get_global_directives(),
                        directives_manager.get_project_directives(project_name)
                        if project_name
                        else "",
                    ]
                    if d
        ...
        raise HTTPException(
            status_code=500, detail="Error obteniendo directivas activas"
        )
...
async def create_default_directives():
    ...
    try:
        ...
        if success:
            ...
            raise HTTPException(
                status_code=500, detail="Error creando directivas por defecto"
            )
    except Exception as e:
