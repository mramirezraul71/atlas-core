...
class EmotionRecognizer:
    ...
    def combine_emotions(
        ...
        combined_valence = (
            face_weight * face_emotion.valence + voice_weight * voice_emotion.valence
        )
        combined_arousal = (
            face_weight * face_emotion.arousal + voice_weight * voice_emotion.arousal
        )
    ...
    def to_dict(self) -> Dict[str, Any]:
        return {
            "last_emotion": self._last_emotion.to_dict()
