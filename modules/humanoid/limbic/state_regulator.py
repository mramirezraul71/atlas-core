...
class InternalState:
    ...
    def is_healthy(self) -> bool:
        ...
        return (
            ...
            and self.motor_health > 0.7
            and self.sensor_health > 0.7
            and self.stress_level < 0.8
        )
    ...
    def can_operate(self) -> bool:
        ...
        return (
            ...
            and self.mode != SystemMode.SLEEP
            and self.energy_level > 0.1
            and self.system_health > 0.3
        )
    ...
    def should_rest(self) -> bool:
        ...
        return (
            ...
            or self.stress_level > 0.9
            or (not self.human_present and self.energy_level < 0.3)
        )
...
class StateRegulator:
    ...
    def update(
        ...
        if cpu_load is not None or task_complexity is not None:
            ...
            self._state.stress_level = (
                0.9 * self._state.stress_level + 0.1 * stress_input
            )
    ...
    def _regulate_mode(self) -> None:
        ...
        # Normal
            ...
            old_mode in (SystemMode.RECOVERY, SystemMode.SLEEP)
            and self._state.is_healthy()
        ):
    ...
    def on_mode_change(
        self, callback: Callable[[SystemMode, SystemMode], None]
    ) -> None:
