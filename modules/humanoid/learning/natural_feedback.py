...
class NaturalLanguageFeedback:
    ...
    async def _apply_correction(
        self, intent: FeedbackIntent, context: Dict[str, Any]
    ) -> None:
        """Aplica correccion."""
    ...
    def is_prohibited(self, action: str) -> bool:
        ...
        for prohibition in self._prohibitions:
            ...
            if target in action_lower or action_lower in target:
                return True
            if instruction and (
                instruction in action_lower or action_lower in instruction
            ):
                return True
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "avg_sentiment": sum(r.intent.sentiment for r in self._history)
            / len(self._history)
            if self._history
            else 0,
        }
