...
from .natural_feedback import FeedbackType, NaturalLanguageFeedback
...
class LearningAPI:
    ...
    async def add_demonstration_step(
    ...
    def create_rl_task(
        ...
        reward_function: Callable[[Dict], float] = None,
    ) -> str:
        """
        Crea tarea de RL.
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        self._stats.average_reward = (
            ...
            if self._stats.rl_episodes_completed > 0
            else 0.0
        )
