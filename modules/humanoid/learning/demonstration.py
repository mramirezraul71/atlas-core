...
class DemonstrationLearning:
    ...
    def __init__(self, storage_path: str = None, sample_rate_hz: float = 100.0):
        """
    ...
    def _save_demonstrations(self) -> None:
        ...
        try:
            data = {
                ...
                "demonstrations": [d.to_dict() for d in self._demonstrations.values()],
            }
    ...
    def predict_action(
        self, task_id: str, current_state: Dict[str, float]
