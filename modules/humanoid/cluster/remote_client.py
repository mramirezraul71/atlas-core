...
def _httpx_get(
    base_url: str, path: str, headers: Dict[str, str], timeout_sec: int
) -> Dict[str, Any]:
    try:
        import urllib.error
        import urllib.request
...
def _signed_headers(
    base_url: str, method: str, path: str, body: Optional[bytes] = None
) -> Dict[str, str]:
...
def get_json(
    base_url: str, path: str, timeout_sec: int = TIMEOUT_DEFAULT, signed: bool = True
) -> Dict[str, Any]:
