...
class SyncConfig:
    ...
    severity_channel_map: Dict[str, List[str]] = field(
...
class SyncEngine:
    ...
    async def sync_to_dashboard(self, event: str, data: Optional[Dict] = None):
        ...
        try:
            ...
            req = urllib.request.Request(f"{self.config.push_url}/status", method="GET")
    ...
    async def notify_channel(self, channel: str, message: str, level: str = "info"):
        """
    ...
    async def notify_all_channels(
        self, message: str, severity: str = "medium", level: str = "info"
    ):
        """
...
def build_pot_context(
    operation: str, user_context: Optional[Dict] = None, auto_values: bool = True
) -> Dict[str, Any]:
    """
...
def sync_operation(operation: str, **kwargs) -> Dict[str, Any]:
    ...
    return {
        ...
        "duration_seconds": (
            ...
            if result.ended_at and result.started_at
            else 0
        ),
    }
