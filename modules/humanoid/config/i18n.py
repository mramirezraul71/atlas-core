...
_STRINGS: Dict[str, Dict[str, str]] = {
    "es": {
        ...
        "cursor.running": "Generando plan…",
        "cursor.plan_hint": "Máx. ~30 s. Requiere Ollama para plan con IA.",
    ...
    "en": {
        ...
        "cursor.running": "Generating plan…",
        "cursor.plan_hint": "Max ~30 s. Requires Ollama for AI plan.",
