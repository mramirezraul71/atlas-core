        ...
        problems.append(
            {
                "id": "config_missing",
                "severity": "warning",
                "message": "config/atlas.env not found",
                "suggestion": "Copy config/atlas.env.example to config/atlas.env",
            }
        )
    else:
            ...
            problems.append(
                {
                    "id": "logs_dir",
                    "severity": "critical",
                    "message": f"Cannot create logs dir: {e}",
                    "suggestion": "Create C:\\ATLAS_PUSH\\logs with write permissions",
                }
            )
            ...
            problems.append(
                {
                    "id": "audit_db",
                    "severity": "warning",
                    "message": "Audit DB not configured",
                    "suggestion": "Set AUDIT_DB_PATH in atlas.env",
                }
            )
    except Exception as e:
        problems.append(
        ...
        problems.append(
            {
                ...
                "severity": "critical",
                "message": str(e),
                "suggestion": "Set SCHED_DB_PATH and ensure logs dir is writable",
            }
        )
        ...
        problems.append(
            {
                ...
                "severity": "warning",
                "message": str(e),
                "suggestion": "Set ATLAS_MEMORY_DB_PATH or disable MEMORY_ENABLED",
            }
        )
