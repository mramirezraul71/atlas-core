...
class ForceTorqueSensor:
    ...
    def calibrate(self, samples: List[WrenchData]) -> Dict[str, Any]:
        ...
        _log.info(
            "F/T sensor calibrated: force_bias=%s, torque_bias=%s",
            self._bias_force,
            self._bias_torque,
        )
    ...
    def process(self, raw_data: Dict[str, Any]) -> WrenchData:
        ...
        self._filtered_force = (
            self._filter_alpha * self._filtered_force + (1 - self._filter_alpha) * force
        )
        self._filtered_torque = (
            self._filter_alpha * self._filtered_torque
    ...
    def get_contact_info(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "force_direction": (
                self._last_wrench.force / max(self._last_wrench.magnitude_force, 1e-6)
            ).tolist(),
