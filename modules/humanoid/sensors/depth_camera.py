...
class DepthCamera:
    ...
    def process(
        self, depth_data: np.ndarray, color_data: Optional[np.ndarray] = None
    ) -> DepthFrame:
        """
    ...
    def detect_obstacles(
        self, frame: DepthFrame, min_height: float = 0.1, max_dist: float = 3.0
    ) -> List[Dict[str, Any]]:
        """
