...
from .service import approve, create, list_all, list_pending, reject
from .store import get, list_items, verify_chain
...
def wait_for_resolution(
    approval_id: str, timeout_seconds: int = 300, poll_seconds: float = 1.5
) -> Dict[str, Any]:
    """
