...
class SemanticMemory:
    ...
    def __init__(self, storage_path: str = None, embedding_model: Any = None):
        """
    ...
    def _save_to_disk(self) -> None:
        ...
        try:
            data = {
                ...
                "concepts": [c.to_full_dict() for c in self._concepts.values()],
            }
    ...
    def add_concept(self, concept: Concept) -> str:
        ...
        _bitacora(
            f"Conocimiento actualizado: {concept.name} tipo={concept.concept_type}"
        )
        return concept.id
    ...
    def get_related(
        self, concept_id: str, relation_type: str = None
    ...
    def query_graph(
        self, start_id: str, path: List[str], max_depth: int = 3
    ) -> List[Concept]:
        """
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "avg_relations_per_concept": total_relations / len(self._concepts)
            if self._concepts
            else 0,
        }
    ...
    def initialize_basic_knowledge(self) -> None:
        ...
        self.create_concept(
            "object", "category", {"description": "Physical thing"}, "initial"
        )
        self.create_concept(
            "location", "category", {"description": "Place or area"}, "initial"
        )
        self.create_concept(
            "person", "category", {"description": "Human being"}, "initial"
        )
        self.create_concept(
            "action",
            "category",
        ...
        # Objetos comunes
        self.create_concept(
            "cup", "object", {"graspable": True, "contains": "liquid"}, "initial"
        )
        self.create_concept(
            "table", "object", {"surface": True, "furniture": True}, "initial"
        )
        self.create_concept(
            "chair", "object", {"sittable": True, "furniture": True}, "initial"
        )
        self.create_concept(
            "bottle", "object", {"graspable": True, "contains": "liquid"}, "initial"
        )

        # Ubicaciones comunes
        self.create_concept("kitchen", "location", {"room_type": "service"}, "initial")
        self.create_concept(
            "living_room", "location", {"room_type": "social"}, "initial"
        )
