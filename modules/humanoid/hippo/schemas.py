...
class Episode:
    ...
    def to_full_dict(self) -> Dict[str, Any]:
        ...
        d["initial_state"] = (
            self.initial_state.to_dict() if self.initial_state else None
        )
        d["final_state"] = self.final_state.to_dict() if self.final_state else None
        d["internal_state"] = (
            self.internal_state.to_dict() if self.internal_state else None
        )
...
class Concept:
    ...
    def add_relation(
        self, relation_type: str, target_id: str, confidence: float = 1.0
    ) -> Relation:
