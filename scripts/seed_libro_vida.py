...
episodes = [
    {
        ...
        "plan_ejecutado": [
            "Detectar tipo de puerta",
            "Calcular fuerza necesaria",
            "Aplicar fuerza gradual",
            "Verificar espacio libre",
            "Mantener puerta abierta",
        ],
        "exito": False,
        "errores": [
            "Fuerza insuficiente en primer intento",
            "Puerta reboto al no mantener presion",
        ],
        "correcciones": [
            "Aumentar fuerza gradualmente",
            "Mantener presion constante hasta apertura completa",
        ],
        "lecciones": "Puertas pesadas requieren fuerza sostenida. No soltar hasta confirmar apertura de 90 grados.",
        "reglas_numericas": {
            "fuerza_puerta_pesada_N": 40,
            "angulo_apertura_seguro_grados": 90,
        },
    ...
    },
    {
        ...
        "plan_ejecutado": [
            ...
            "Ajustar centro de gravedad",
            "Subir escalon por escalon",
            "Verificar agarre en cada escalon",
        ],
        "exito": True,
        ...
        "reglas_numericas": {
            "peso_max_escaleras_kg": 8,
            "velocidad_reduccion_pct": 50,
            "verificar_agarre_cada_escalones": 3,
        },
    ...
    },
    {
        ...
        "plan_ejecutado": [
            "Detectar presencia de menores",
            "Reducir velocidad a minima",
            "Anunciar presencia verbalmente",
            "Acercar lentamente",
            "Ofrecer objeto a distancia segura",
            "Soltar suavemente",
        ],
        "exito": True,
        "lecciones": "Con ninos: velocidad maxima 0.2 m/s, distancia minima 1m, siempre anunciar presencia.",
        "reglas_numericas": {
            "velocidad_max_ninos_ms": 0.2,
            "distancia_min_ninos_m": 1.0,
            "fuerza_entrega_max_N": 5,
        },
    ...
    },
    {
        ...
        "tipo_tarea": "patrulla",
        "plan_ejecutado": [
            "Activar sensores nocturnos",
            "Seguir ruta predefinida",
            "Escanear anomalias",
            "Reportar estado cada punto de control",
        ],
        "exito": True,
    ...
    },
    {
        ...
        "tipo_tarea": "limpieza",
        "plan_ejecutado": [
            "Detectar extension del derrame",
            "Senalizar zona",
...
for ep in episodes:
    ...
    print(
        f"  {status}: {ep['tarea'][:50]} -> {d.get('episodio_id', d.get('error','?'))}"
    )

principios = [
    {
        "categoria": "seguridad",
        "principio": "Cerca de humanos, reducir velocidad al 50% y aumentar distancia minima a 1m",
        "confianza": 0.9,
    },
    {
        "categoria": "seguridad",
        "principio": "Con ninos presentes, velocidad maxima 0.2 m/s y anunciar presencia",
        "confianza": 0.95,
    },
    {
        "categoria": "manipulacion",
        "principio": "Objetos fragiles requieren agarre con fuerza limitada (max 15N) y verificacion continua",
        "confianza": 0.85,
    },
    {
        "categoria": "navegacion",
        "principio": "En pasillos estrechos (<1.5m), reducir velocidad a 0.3 m/s y mantener 30cm de paredes",
        "confianza": 0.8,
    },
    {
        "categoria": "escaleras",
        "principio": "Subir/bajar con carga: reducir velocidad 50%, verificar agarre cada 3 escalones, peso max 8kg",
        "confianza": 0.85,
    },
    {
        "categoria": "puertas",
        "principio": "Puertas pesadas requieren fuerza sostenida y no soltar hasta apertura de 90 grados",
        "confianza": 0.8,
    },
    {
        "categoria": "limpieza",
        "principio": "Siempre senalizar zona antes de limpiar y verificar que no quede riesgo de resbalon",
        "confianza": 0.75,
    },
]
